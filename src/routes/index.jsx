...
//import view sholawats index
import SholawatsIndex from '../views/Admin/Sholawats/Index';

//import view sholawats create
import SholawatsCreate from '../views/admin/sholawats/create';

//import view sholawats edit
import SholawatsEdit from '../views/Admin/Sholawats/Edit';

//import view kerontangs index
import KerontangsIndex from '../views/Admin/Kerontangs/Index';

//import view kerontangs create
import KerontangsCreate from '../views/admin/kerontangs/create';

//import view kerontangs edit
import KerontangsEdit from '../views/Admin/Kerontangs/Edit';
...
export default function RoutesIndex() {
  return (
    <Routes>
      ...
      {/* private route "/admin/sholawats" */}
      <Route
        path="/admin/sholawats"
        element={
          <PrivateRoutes>
            <SholawatsIndex />
          </PrivateRoutes>
      ...
      {/* private route "/admin/sholawats/create" */}
      <Route
        path="/admin/sholawats/create"
        element={
          <PrivateRoutes>
            <SholawatsCreate />
          </PrivateRoutes>
      ...
      {/* private route "/admin/sholawats/edit" */}
      <Route
        path="/admin/sholawats/edit/:id"
        element={
          <PrivateRoutes>
            <SholawatsEdit />
          </PrivateRoutes>
      ...
      {/* private route "/admin/kerontangs" */}
      <Route
        path="/admin/kerontangs"
        element={
          <PrivateRoutes>
            <KerontangsIndex />
          </PrivateRoutes>
      ...
      {/* private route "/admin/kerontangs/create" */}
      <Route
        path="/admin/kerontangs/create"
        element={
          <PrivateRoutes>
            <KerontangsCreate />
          </PrivateRoutes>
      ...
      {/* private route "/admin/kerontangs/edit" */}
      <Route
        path="/admin/kerontangs/edit/:id"
        element={
          <PrivateRoutes>
            <KerontangsEdit />
          </PrivateRoutes>
