...
export default function WebKerontangsShow() {
  ...
  const fetchDetailDataPost = async () => {
    ...
    //fetch data
    await Api.get(`/api/public/kerontangs/${slug}`).then((response) => {
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <h5 className="text-uppercase">
              <i className="fa fa-book"></i> KERONTANG TERBARU
            </h5>
            <hr />
            {loadingPosts ? (
              <Loading />
