...
export default function WebSholawatsShow() {
  ...
  const fetchDetailDataPost = async () => {
    ...
    //fetch data
    await Api.get(`/api/public/sholawats/${slug}`).then((response) => {
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <h5 className="text-uppercase">
              <i className="fa fa-book"></i> SHOLAWAT TERBARU
            </h5>
            <hr />
            {loadingPosts ? (
              <Loading />
