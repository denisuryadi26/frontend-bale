...
export default function PostsIndex() {
  ...
  const fetchData = async (pageNumber = 1, keywords = '') => {
    ...
    await Api.get(`/api/admin/kerontangs?search=${keywords}&page=${page}`, {
      //header
      headers: {
        //header Bearer + Token
      ...
      buttons: [
        {
          label: 'YES',
          onClick: async () => {
            await Api.delete(`/api/admin/kerontangs/${id}`, {
              //header
              headers: {
                //header Bearer + Token
                Authorization: `Bearer ${token}`,
        ...
        <div className="container-fluid mb-5 mt-5">
          <div className="row">
            <div className="col-md-8">
              <div className="row">
                {hasAnyPermission(['kerontangs.create']) && (
                  <div className="col-md-3 col-12 mb-2">
                    <Link
                      to="/admin/kerontangs/create"
                            ...
                            posts.map((post, index) => (
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  {hasAnyPermission(['kerontangs.edit']) && (
                                    <Link
                                      to={`/admin/kerontangs/edit/${post.id}`}
