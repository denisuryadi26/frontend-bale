...
export default function SholawatsIndex() {
  ...
  const fetchData = async (pageNumber = 1, keywords = '') => {
    ...
    await Api.get(`/api/admin/sholawats?search=${keywords}&page=${page}`, {
      //header
      headers: {
        //header Bearer + Token
      ...
      buttons: [
        {
          label: 'YES',
          onClick: async () => {
            await Api.delete(`/api/admin/sholawats/${id}`, {
              //header
              headers: {
                //header Bearer + Token
                Authorization: `Bearer ${token}`,
        ...
        <div className="container-fluid mb-5 mt-5">
          <div className="row">
            <div className="col-md-8">
              <div className="row">
                {hasAnyPermission(['sholawats.create']) && (
                  <div className="col-md-3 col-12 mb-2">
                    <Link
                      to="/admin/sholawats/create"
                            ...
                            sholawats.map((post, index) => (
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  {hasAnyPermission(['sholawats.edit']) && (
                                    <Link
                                      to={`/admin/sholawats/edit/${post.id}`}
                                  ...
                                  {hasAnyPermission(['sholawats.delete']) && (
                                    <button
